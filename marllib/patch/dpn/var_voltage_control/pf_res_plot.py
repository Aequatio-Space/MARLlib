...
def pf_res_plotly(net, cmap="Jet", use_line_geodata=None, on_map=False, projection=None,
    ...
    hoverinfo = (
            ...
            'V_a = ' + net.res_bus.va_degree.round(precision).astype(str) + ' deg').toItemList()
    ...
    hoverinfo = (
            ...
            'I_to = ' + net.res_line.i_to_ka.round(precision).astype(str) + ' kA' + '<br />').toItemList()
    ...
    hoverinfo = (
            ...
            'I_lv = ' + net.res_trafo.i_lv_ka.round(precision).astype(str) + ' kA' + '<br />').toItemList()
